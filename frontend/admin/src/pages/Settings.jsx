...
const T = {
  fa: {
    ...
    src_info: 'این‌ها شماره‌هایی هستند که بانک با آن‌ها پیامک واریز وجه ارسال می‌کند (مثلاً 10008556 برای بانک ملت). فقط پیامک‌های دریافتی از این شماره‌ها برای تأیید خودکار پرداخت بررسی می‌شوند؛ پیامک از شماره‌های دیگر ذخیره می‌شود ولی نادیده گرفته می‌شود.',
...
const HINT = {
  fa: {
    backup_interval_minutes: 'پیش‌فرض: 1440 (24 ساعت)',
    ...
    alert_volume_percent: 'مثلاً 80% مصرف',
    alert_expire_days: 'ارسال نوتیفیکیشن پیش از اتمام مهلت',
    service_sync_interval_minutes: 'پیش‌فرض: 60 — هر چند دقیقه وضعیت سرویس‌ها از پنل‌ها خوانده شود',
  },
  en: {
