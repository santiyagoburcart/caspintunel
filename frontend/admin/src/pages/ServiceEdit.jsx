...
const T = {
  fa: {
    ...
    plus30: '+30 روز', clear_expiry: 'بدون انقضا',
    ...
    f_lifetime: 'مصرف کل عمر اکانت', f_reset: 'بازنشانی خودکار حجم', f_hwid: 'محدودیت دستگاه (HWID)', hwid_label: 'محدودیت تعداد دستگاه (HWID Device Limit)', hwid_hint: 'حداکثر دستگاه‌هایی که می‌توانند با این اکانت متصل شوند — خالی یا 0 = نامحدود', devices: 'دستگاه', f_ours: 'ثبت در سیستم ما',
    f_source: 'منبع', none: '—',
